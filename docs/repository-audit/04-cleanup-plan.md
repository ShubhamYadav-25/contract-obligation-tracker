...
| UC-ENV-005    | MANUAL_DECISION | Gemini env depends on extraction pipeline/provider roadmap.                                                                       |
